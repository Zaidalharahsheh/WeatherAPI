...
// displays the current city, weather, 
async function displayWeather() {
    var queryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + cityname + "&units=imperial&appid=6c150e643a7fb4864ca321fafb7653b2"
    ...
    var uvURL = "https://api.openweathermap.org/data/2.5/uvi?appid=6c150e643a7fb4864ca321fafb7653b2&lat=" + getLat + "&lon=" + getLong;
...
async function displayFiveDayForecast() {
    var queryURL = "https://api.openweathermap.org/data/2.5/forecast?q=" + cityname + "&units=imperial&appid=6c150e643a7fb4864ca321fafb7653b2";
    var response = await $.ajax({
        url: queryURL,
        method: "GET"
    })
